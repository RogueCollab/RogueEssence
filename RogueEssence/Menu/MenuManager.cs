...
namespace RogueEssence.Menu
{
    public class MenuManager
    {
        ...
        {
            return SetDialogue(MonsterID.Invalid, null, new EmoteStyle(0), true, () => { }, -1, true, false, msgs);
        }
        ...
        {
            return SetDialogue(MonsterID.Invalid, null, new EmoteStyle(0), true, finishAction, -1, false, false, msgs);
        }
        ...
        {
            return SetDialogue(speaker, speakerName, emotion, sound, () => { }, -1, false, false, msgs);
        }
        public IEnumerator<YieldInstruction> SetDialogue(MonsterID speaker, string speakerName, EmoteStyle emotion, bool sound, Action finishAction, int waitTime, bool autoFinish, bool centered, params string[] msgs)
        {
            DialogueBox box = CreateDialogue(speaker, speakerName, emotion, sound, finishAction, waitTime, autoFinish, centered, msgs);
        ...
        {
            return CreateDialogue(MonsterID.Invalid, null, new EmoteStyle(0), true, finishAction, -1, false, false, msgs);
        }
        ...
        {
            return CreateDialogue(speaker, speakerName, emotion, sound, () => { }, -1, false, false, msgs);
        }
        public DialogueBox CreateDialogue(MonsterID speaker, string speakerName, EmoteStyle emotion, bool sound, Action finishAction, int waitTime, bool autoFinish, bool centered, params string[] msgs)
        {
            if (msgs.Length > 0)
            {
                ...
                for (int ii = sep_msgs.Count - 1; ii >= 0; ii--)
                {
                    ...
                    box = CreateBox(speaker, speakerName, emotion, sound, (prevBox == null) ? finishAction : () => { AddMenu(prevBox, false); }, waitTime, autoFinish, centered, sep_msgs[ii]);
                }
                return box;
            }
            return null;
        ...
        public DialogueBox CreateBox(MonsterID speaker, string speakerName, EmoteStyle emotion, bool sound,
             Action finishAction, int waitTime, bool autoFinish, bool centered, string msg)
        {
            DialogueBox box = null;
            if (waitTime > -1)
                box = new TimedDialog(msg, sound, centered, waitTime, finishAction);
            else
                box = new ClickedDialog(msg, sound, centered, finishAction);
        ...
        {
            return CreateQuestion(MonsterID.Invalid, null, new EmoteStyle(0), message, true, false, false, yes, no, false);
        }
        public DialogueBox CreateQuestion(string message, bool sound, Action yes, Action no)
        {
            return CreateQuestion(MonsterID.Invalid, null, new EmoteStyle(0), message, sound, false, false, yes, no, false);
        }
        public DialogueBox CreateQuestion(string message, bool sound, Action yes, Action no, bool defaultNo)
        {
            return CreateQuestion(MonsterID.Invalid, null, new EmoteStyle(0), message, sound, false, false, yes, no, defaultNo);
        }

        public DialogueBox CreateQuestion(MonsterID speaker, string speakerName, EmoteStyle emotion,
            string msg, bool sound, bool autoFinish, bool centered, Action yes, Action no, bool defaultNo)
        {
            ...
            DialogueBox box = new QuestionDialog(break_str[break_str.Length-1], sound, false, choices, defaultNo ? 1 : 0, 1);
            box.SetSpeaker(speaker, speakerName, emotion);
            if (autoFinish)
                box.Text.FinishText();
            ...
            if (break_str.Length > 1)
            {
                ...
                return CreateDialogue(speaker, speakerName, emotion, sound, () => { AddMenu(box, false); }, -1, autoFinish, centered, pre_str);
            }
            else
                return box;
        }
        ...
        {
            return CreateMultiQuestion(MonsterID.Invalid, null, new EmoteStyle(0), message, sound, false, false, choices.ToArray(), defaultChoice, cancelChoice);
        }
        ...
        {
            return CreateMultiQuestion(MonsterID.Invalid, null, new EmoteStyle(0), message, sound, false, false, choices, defaultChoice, cancelChoice);
        }

        public DialogueBox CreateMultiQuestion(MonsterID speaker, string speakerName, EmoteStyle emotion,
            string msg, bool sound, bool autoFinish, bool centered, DialogueChoice[] choices, int defaultChoice, int cancelChoice)
        {
            string[] break_str = Regex.Split(msg, "\\[br\\]", RegexOptions.IgnoreCase);

            DialogueBox box = new QuestionDialog(break_str[break_str.Length - 1], sound, false, choices, defaultChoice, cancelChoice);
            box.SetSpeaker(speaker, speakerName, emotion);
            if (autoFinish)
                box.Text.FinishText();
