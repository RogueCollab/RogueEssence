    ...
    public class HotkeyMenu : MenuBase
    {
        ...
        public void SetSkill(string skillName, int element, int charges, int max, bool skillSealed)
        {
            if (!String.IsNullOrWhiteSpace(skillName))
            {
                ...
                skillText.Text = "[" + DiagManager.Instance.CurSettings.ActionKeys[skillSlot + (int)FrameInput.InputType.Skill1].ToLocal() + "]: " + skillName;
            ...
            {
                skillText.Text = "[" + DiagManager.Instance.CurSettings.ActionKeys[skillSlot + (int)FrameInput.InputType.Skill1].ToLocal() + "]";
