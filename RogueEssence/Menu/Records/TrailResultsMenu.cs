...
namespace RogueEssence.Menu
{
    public class TrailResultsMenu : SideScrollMenu
    {
        ...
        public TrailResultsMenu(GameProgress ending, int page) : this(MenuLabel.RESULTS_MENU_TRAIL, ending, page) { }
        public TrailResultsMenu(string label, GameProgress ending, int page)
        {
            Label = label;
