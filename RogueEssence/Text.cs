...
namespace RogueEssence
{
    ...
    public static class Text
    {
        ...
        public static Regex MsgTags = new Regex("(?<pause>\\[pause=(?<pauseval>\\d+)\\])|(?<colorstart>\\[color=#(?<colorval>[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f])\\])|(?<colorend>\\[color\\])|(?<boxbreak>\\[br\\])|(?<scrollbreak>\\[scroll\\])", RegexOptions.Compiled | RegexOptions.IgnoreCase);
