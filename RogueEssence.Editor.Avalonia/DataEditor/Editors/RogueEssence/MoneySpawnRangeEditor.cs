...
{
    public class MoneySpawnRangeEditor : Editor<MoneySpawnRange>
    {
        /// <summary>
        ...
        public override void LoadWindowControls(StackPanel control, string parent, Type parentType, string name, Type type, object[] attributes, MoneySpawnRange member, Type[] subGroupStack)
        {
            int addMin, addMax;
        ...
        public override MoneySpawnRange SaveWindowControls(StackPanel control, string name, Type type, object[] attributes, Type[] subGroupStack)
        {
            int addMin, addMax;
            getMinMaxOffsets(attributes, out addMin, out addMax);
            ...
            return new MoneySpawnRange((int)nudValueX.Value - addMin, (int)nudValueY.Value - addMax);
        }

        public override string GetString(MoneySpawnRange obj, Type type, object[] attributes)
        {
            int addMin, addMax;
            getMinMaxOffsets(attributes, out addMin, out addMax);
