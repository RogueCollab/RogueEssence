...
namespace RogueEssence.Dev
{
    public class ColorEditor : Editor<Color>
    {
        ...
        public override void LoadWindowControls(StackPanel control, string parent, Type parentType, string name, Type type, object[] attributes, Color member, Type[] subGroupStack)
        {
