...
namespace RogueEssence.Dev
{
    public class Editor<T> : IEditor
    {
        ...
        void IEditor.LoadWindowControls(object obj, StackPanel control)
        {
        ...
        void IEditor.SaveClassControls(StackPanel control, string name, Type type, object[] attributes, ref object member, bool isWindow)
        {
            T mem = (T)member;
        ...
        void IEditor.SaveWindowControls(object obj, StackPanel control)
        {
            SaveWindowControls((T)obj, control);
        }

        void IEditor.SaveMemberControl(object obj, StackPanel control, string name, Type type, object[] attributes, ref object member, bool isWindow)
        {
