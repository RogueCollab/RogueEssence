...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        private DataListFormViewModel createChoices(DataListForm form, DataManager.DataType dataType, GetEntry entryOp, CreateEntry createOp)
        {
            ...
            {
                if ((dataType & (DataManager.DataType.Zone | DataManager.DataType.AutoTile | DataManager.DataType.Terrain | DataManager.DataType.Tile | DataManager.DataType.Rank | DataManager.DataType.AI | DataManager.DataType.GrowthGroup | DataManager.DataType.SkillGroup | DataManager.DataType.Emote)) != DataManager.DataType.None)
                {
            ...
            {
                if ((dataType & (DataManager.DataType.Zone | DataManager.DataType.AutoTile | DataManager.DataType.Terrain | DataManager.DataType.Tile | DataManager.DataType.Rank | DataManager.DataType.Tile | DataManager.DataType.Emote | DataManager.DataType.SkillGroup | DataManager.DataType.Emote)) != DataManager.DataType.None)
                {
