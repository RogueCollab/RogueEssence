...
public class GroundEditPageViewModel : EditorPageViewModel, IGroundEditor, IPreCreatePage, IPageReloadable
{
    ...
    public GroundEditPageViewModel(EditorContext context, NodeBase node,
